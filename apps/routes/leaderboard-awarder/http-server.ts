import { LeaderboardAwarderService } from '.';

export class HealthCheckServer {
	private server: any;
	private workerService: LeaderboardAwarderService;
	private port: number;

	constructor(port = 3000, workerService: LeaderboardAwarderService) {
...
export function startHealthCheckServer(
	port: number,
	workerService: LeaderboardAwarderService,
): HealthCheckServer {
