export const ca_MC = {
	...
	channelAlreadyExists:
		'Caveat-Initiate, designation exists within the noosphere!',
	channelLimitReached:
		'Moderation-Protocol! You have exceeded your channel creation threshold.',
	groupAlreadyExists:
		'Caution: The collective designation is already in registry.',
	groupLimitReached:
		'Excess-Warning! Group creation has reached its specified limit.',
	unknownBackendError:
		'Anomaly detected in the machine spirit. Rectification is imminent.',
	...
	sessionNotFound:
		'Session data absent or non-existent. Existence verification required.',
	emailTaken:
		'The electronic missive is already recorded within the data vaults.',
	emailNotFound:
		'No record of such an electronic missive exists within our archives.',
	...
	youHaveNoChannelByThatName:
		'No channel with the specified cognomen is registered to you.',
	youHaveNoChannelByThatId:
		'No channel with the specified identification exists in your ledger.',
	...
	imageUploadAuthorizationError:
		'Link to image host is severed. Cause unknown.',
	videoUploadAuthorizationError:
		'Link to vid-capture host is severed. Cause unknown.',
	noPostByYou:
		'No post with the provided identification exists in your script.',
