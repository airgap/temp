export const en_US_angry = {
	...
	"streamCreationError": "Looks like my server fucked up and didn't create your stream right. Meh",
	"sessionNotFound": "Either you're a *DIRTY HACKER* or your session expired and you need to log in again",
	"emailTaken": "You already made an account with that email you retard. Just log in",
	...
	"invalidRequestParams": "You sent valid JSON but didn't bother to fill it out properly? Dumbass",
