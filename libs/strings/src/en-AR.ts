export const en_AR = {
  ...
  channelAlreadyExists:
    "Arr matey, some scallywag's already claimed that channel name!",
  channelLimitReached:
    "Avast! Ye be havin' too many channels. Weigh anchor a bit!",
  groupAlreadyExists:
    "Shiver me timbers! That group name's been plundered already.",
  groupLimitReached:
    "Ye be creatin' a whole fleet o' groups. Maybe furl yer sails some?",
  unknownBackendError:
    "There be a squall in me server. I'll be settin' it right soon, I hope.",
  unknownFrontendError:
    "Yo-ho-ho, something's gone all askew and I know not what!",
  streamCreationError:
  ...
  invalidRequestJson:
    "API calls should be in JSON format, but yours be lookin' strange.",
  invalidRequestParams:
    "Ye sent the right type o' message, but with the wrong treasures.",
  ...
  imageUploadAuthorizationError:
    "We can't connect to our image port... can't fathom why, har har!",
  videoUploadAuthorizationError:
    "We can't connect to our video port... can't fathom why, har har!",
