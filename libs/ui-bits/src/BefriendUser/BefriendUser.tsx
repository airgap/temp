    ...
    case 'befriended':
      return (
        <CoolLink
          onClick={() => {
            setStatus(undefined);
            api.deleteFriendship(user.id).then(() => setStatus('none'));
          }}
        >
      ...
      return (
        <>
          ...
          <CoolLink
            onClick={() => {
              setStatus(undefined);
              api.declineFriendRequest(user.id).then(() => setStatus('none'));
            }}
          >
