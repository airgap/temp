...
export const PostCreator = ({
	...
	const post = async () => {
		...
		const { error, id, imageDrafts, videoDrafts } = await api.draftPost({
			body,
		...
		setId(id);
		setImageDrafts(imageDrafts);
		setVideoDrafts(videoDrafts);
		console.log(
		...
		<div className={styles.PostCreator}>
			...
			<div className={classnames({ [styles.newPost]: replyToPost })}>
				...
				<div className={styles.UserDetails}>
					<ProfilePicture
						url={profilePicture ?? defaultImages.ProfilePicture}
						size="m"
					/>
