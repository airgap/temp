...
import { AttachmentDraft, ImageUploadReason } from '@lyku/json-models';
...
type Props = {
	...
	| {
			file: File;
			removeClicked?: () => void;
			attachmentUploadPack: AttachmentDraft;
			onFinished: () => void;
	  }
);

export const defaultImages: Record<ImageUploadReason, string> = {
	ActiveChannelBackground: bg,
	AwayChannelBackground: bg,
	ChannelLogo: 'bbce90da-abe2-4970-4b54-6c9034496d00',
	ProfilePicture: 'bbce90da-abe2-4970-4b54-6c9034496d00',
	...
	return (
		...
		>
			...
			<input
				...
				onChange={event =>
					imageSelected(event.target as HTMLInputElement)
				}
			/>
