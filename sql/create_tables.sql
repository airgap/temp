...
-----------------------------
---- Create table
CREATE TABLE IF NOT EXISTS "groupIconDrafts" (
  "creator" BIGINT NOT NULL,
...
---- Create indexes
CREATE INDEX IF NOT EXISTS "idx_groupIconDrafts_creator" ON "groupIconDrafts" ("creator");


CREATE INDEX IF NOT EXISTS "idx_groupIconDrafts_type" ON "groupIconDrafts" ("type");


CREATE INDEX IF NOT EXISTS "idx_groupIconDrafts_created" ON "groupIconDrafts" ("created");


CREATE INDEX IF NOT EXISTS "idx_groupIconDrafts_creator" ON "groupIconDrafts" ("creator");


CREATE INDEX IF NOT EXISTS "idx_groupIconDrafts_group" ON "groupIconDrafts" ("group");
------------------------------
-----  groupMemberships  -----
------------------------------
---- Create table
