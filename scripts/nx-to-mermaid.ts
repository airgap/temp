...
async function generateMermaidFromNxGraph(): Promise<string> {
  ...
  // Add styling
  mermaid += '\n';
  mermaid += 'classDef appStyle fill:#ff6b6b,stroke:#d63447,stroke-width:2px,color:#fff\n';
  mermaid += 'classDef libStyle fill:#4ecdc4,stroke:#26d0ce,stroke-width:2px,color:#fff\n';
